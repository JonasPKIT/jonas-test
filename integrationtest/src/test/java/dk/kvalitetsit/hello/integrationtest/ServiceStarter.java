...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("jonas-test");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "jonas-test-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/jonas-test-qa:dev")
